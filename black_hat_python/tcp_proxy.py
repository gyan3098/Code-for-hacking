...
def server_loop(local_host,local_port,remote_host,remote_port,receive_first):
    ...
    while True:
        ...
        # print oout the local connection information
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    if receive_first:
        ...
        #if we have data to send to our local_client, send it
...
def hexdump(src, length=16):
    ...
    for x in xrange(0, len(src), length):
        s = src[i:i+length]
...
def receive_from(connection):
    buffer = ""
    # we get a 2 second timeout; depending on your 
...
# odify any requests destined for the remote host
